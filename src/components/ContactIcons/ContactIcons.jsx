...
const ContactIcon = ({ href, src, alt }) => {
  return (
    ...
    >
      <Image className={styles.Icon} src={src} alt={alt} width={50} height={50} />
    </a>
  );
};
